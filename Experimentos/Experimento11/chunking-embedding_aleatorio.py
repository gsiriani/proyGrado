...
archivo_acc = path_proyecto + './accuracy.png'
archivo_loss = path_proyecto + './loss.png'
...
history = model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=50, batch_size=100, verbose=2)
