...
unidades_ocultas_capa_3_pos = 11

archivo_embedding = path_proyecto + "/embedding/embedding_total.txt"
archivo_lexicon = path_proyecto + "/embedding/lexicon_total.txt"
archivo_corpus_entrenamiento_ner = path_proyecto + '/corpus/Ventana_indizada/Entrenamiento/ner_training_out_tag.csv'
archivo_corpus_pruebas_ner = path_proyecto + '/corpus/Ventana_indizada/Pruebas/ner_pruebas_out_tag.csv'
archivo_corpus_entrenamiento_chunking = path_proyecto + '/corpus/Ventana_indizada/Entrenamiento/chunking_training_out_tag.csv'
archivo_corpus_pruebas_chunking = path_proyecto + '/corpus/Ventana_indizada/Pruebas/chunking_pruebas_out_tag.csv'
archivo_corpus_entrenamiento_pos = path_proyecto + '/corpus/Ventana_indizada/Entrenamiento/pos_simple_training.csv'
archivo_corpus_pruebas_pos = path_proyecto + '/corpus/Ventana_indizada/Pruebas/pos_simple_pruebas.csv'
...
log += '\nTareas: NER, Chunking y POS Simple'
...
model_ner.compile(loss='categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])
model_ner.summary()
model_chunking.compile(loss='categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])
model_chunking.summary()
model_pos.compile(loss='categorical_crossentropy', optimizer=sgd, metrics=['accuracy'])
model_pos.summary()
