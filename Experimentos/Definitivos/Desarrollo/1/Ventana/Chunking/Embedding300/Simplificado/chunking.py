...
vector_size = 300 # Cantidad de features a considerar por palabra
unidades_ocultas_capa_2 = 300
unidades_ocultas_capa_3 = 13 # SE MODIFICA PARA CADA PROBLEMA A RESOLVER
...
archivo_corpus_entrenamiento = path_proyecto + '/corpus/Ventana/Entrenamiento/chunking_simplificado_training.csv'
archivo_corpus_pruebas = path_proyecto + '/corpus/Ventana/Pruebas/chunking_simplificado_pruebas.csv'

archivo_acc = './accuracy.png'
archivo_loss = './loss.png'

log = 'Log de ejecucion:\n-----------------\n'
log += '\nTarea: Chunking Simplificado'
log += '\nModelo de red: Ventana'
log += '\nEmbedding inicial: Aleatorio'
log += '\nOptimizer: adam'
log += '\nActivacion: relu'
log += '\nFeatures en embedding: ' + str(vector_size)
