...
for p in range(cantidad_casos_test):
	print_progress(p, cantidad_casos_test, prefix = 'Progreso:', suffix = 'Completado', bar_length = 50)
	...
	if chunk_esperado == chunk_pred:
		chunk_correctos += 1
print_progress(cantidad_casos_test, cantidad_casos_test, prefix = 'Progreso:', suffix = 'Completado', bar_length = 50)
