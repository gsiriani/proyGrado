...
archivo_corpus_entrenamiento = path_proyecto + '/corpus/Ventana/Entrenamiento/supertag_all_training.csv'
archivo_corpus_pruebas = path_proyecto + '/corpus/Ventana/Pruebas/supertag_all_pruebas.csv'

archivo_acc = './accuracy.png'
archivo_loss = './loss.png'

log = 'Log de ejecucion:\n-----------------\n'
log += '\nTarea: SuperTagging Completo'
