...
def main(tarea, cantidad_iteraciones = 20, precalculado = False):
	...
	x_train_a, x_train_b, x_train_c, y_train = cargarCasos(archivo_corpus_entrenamiento, srl)

	print 'Cargando casos de prueba...' 
	x_test_a, x_test_b, x_test_c, y_test = cargarCasos(archivo_corpus_pruebas, srl)
