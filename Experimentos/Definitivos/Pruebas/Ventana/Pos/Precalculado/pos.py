...
archivo_corpus_entrenamiento = path_proyecto + '/corpus/Ventana/Entrenamiento/pos_simple_training.csv'
archivo_corpus_pruebas = path_proyecto + '/corpus/Ventana/Pruebas/pos_simple_pruebas.csv'
