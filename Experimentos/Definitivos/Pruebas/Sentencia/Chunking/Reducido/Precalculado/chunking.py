...
archivo_corpus_entrenamiento = path_proyecto + '/corpus/Sentencia_truncada/Entrenamiento/chunking_reducido_training.csv'
archivo_corpus_pruebas = path_proyecto + '/corpus/Sentencia_truncada/Pruebas/chunking_reducido_pruebas.csv'
