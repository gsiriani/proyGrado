...
neuronas_salida_main = 4 # SE MODIFICA PARA CADA PROBLEMA A RESOLVER
...
archivo_corpus_entrenamiento = path_proyecto + '/corpus/Ventana_indizada/Entrenamiento/ner_training_iobes_separado.csv'
archivo_corpus_pruebas = path_proyecto + '/corpus/Ventana_indizada/Pruebas/ner_pruebas_iobes_separado.csv'
...
input_layer = Input(shape=(window_size,), name='input_layer')
