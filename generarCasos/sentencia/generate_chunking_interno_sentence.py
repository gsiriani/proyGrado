...
output_training_file = open(output_folder + "/" + "chunking_interno_training.csv","w")
output_testing_file = open(output_folder + "/" + "chunking_interno_testing.csv","w")
output_pruebas_file = open(output_folder + "/" + "chunking_interno_pruebas.csv","w")
